...
StoryForge exports its Interactive Narrative outputs into three formats natively: JSON, YAML, and CSV.
...
Because StoryForge objects (like `Campaigns`) inherently contain lists of IDs or sub-objects, the StoryForge `StructuredExportLayer` automatically flattens these fields.
...
`exports/unreal/interactive_narrative/`
